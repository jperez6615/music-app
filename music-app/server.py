...
def stream():
    ...
    opts = {**ydl_opts_base(), 'format': 'bestaudio[ext=webm]/bestaudio[ext=m4a]/bestaudio/best'}
    try:
        with yt_dlp.YoutubeDL(opts) as ydl:
...
if __name__ == '__main__':
    ...
    has_cookies = '✅' if COOKIES_FILE.exists() else '❌ (sube cookies.txt para evitar bloqueos)'
